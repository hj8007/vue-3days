본 깃허브 레파지토리의 모든 코드 소스 및 기술 내용에 대한 라이센스는 라이센스 문서를 반드시 확인하세요. 강의 수강자외에 활용을 금지합니다.
...
6. 강의 진행시 강사 질문에 대한 긍정은 y, 부정은 n 으로 의사 표현해주세요. 예를들어 "설치가 잘 되었나요?"라고 물었을 때 잘 되었으면, y 를 채팅창에 남겨주세요.
7. 9시 수업시작, 50분 수업, 10분 쉬는 시간, 점심(11시50분~13시00분)
8. 카메라는 on/off 선택, 마이크 off(발언시에만 on)
...
- Prettier ([https://prettier.io/docs/en/options.html](https://prettier.io/docs/en/options.html))
